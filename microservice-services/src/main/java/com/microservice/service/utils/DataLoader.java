...
//        );
//
//        List<AlojamientoModel> listaAlojamiento = Arrays.asList(
...
//
//
//        alojamientoRepository.saveAll(listaAlojamiento);
//
...
//                        .alojamiento(listaAlojamiento.get(0))
//                        .cliente(cliente)
...
//
//                Alojamiento_Persona.builder()
//                        .alojamiento(listaAlojamiento.get(1))
//                        .cliente(cliente)
...
//
//                Alojamiento_Persona.builder()
//                        .alojamiento(listaAlojamiento.get(2))
//                        .cliente(cliente)
...
//
//                Alojamiento_Persona.builder()
//                        .alojamiento(listaAlojamiento.get(3))
//                        .cliente(cliente)
...
//
//                Alojamiento_Persona.builder()
//                        .alojamiento(listaAlojamiento.get(4))
//                        .cliente(cliente)
